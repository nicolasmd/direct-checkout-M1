...
class Sinabs_Directcheckout_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	/**
	 * XML path enable gift message option
	 * 
	 */
	const XML_PATH_DIRECTCHECKOUT_OPTIONS_ENABLED_GIFT = 'directcheckout/options/enable_gift';
	
	/**
	 * XML path gift message option price
	 * 
	 */
	const XML_PATH_DIRECTCHECKOUT_OPTIONS_GIFT_PRICE = 'directcheckout/options/gift_price';
    ...
    /**
     * Is enabled gift message option
     *
     * @return boolean
     */
    public function isGiftMessageEnabled()
    {
    	return Mage::getStoreConfig(self::XML_PATH_DIRECTCHECKOUT_OPTIONS_ENABLED_GIFT);
    }
    
    /**
     * Get price of gift message option
     *
     * @return boolean
     */
    public function getGiftMessagePrice()
    {
    	return Mage::getStoreConfig(self::XML_PATH_DIRECTCHECKOUT_OPTIONS_GIFT_PRICE);
    }
    ...
    {
    	$product = Mage::getModel('catalog/product')->loadByAttribute('sku', 'CADEAU');
